...
export default function Home() {
  ...
  const onSearhHotel = () => {
    ...
    navigate(
      `/hotel/search?city=${city.current.value}&total_guest=${total_guest.current.value}&check_in=${check_in}&check_out=${check_out}`
    );
  };
  ...
  return (
    <>
      {/* Jumbotron Section */}
      <div
        className="home-jumbotron flex justify-center py-8"
        style={{ height: "200px" }}
      >
        <h1 className="text-4xl text-white font-light mr-1">Hai,</h1>
        <h1 className="text-4xl text-white font-semibold">mau ke mana?</h1>
      </div>

      {/* Search Box Section */}
      <div
        className="grid grid-cols-1 flex justify-center px-52"
        ...
        <div className="bg-white rounded-md drop-shadow-xl px-10 py-5">
          <div>
            <span
              ...
              className={
                selectMenu === 0
                  ? "text-lg text-sky-500 font-semibold border-b-2 border-sky-500"
                  : "text-lg"
              }
            >
              Hotel
            ...
            <span
              ...
              className={
                selectMenu === 1
                  ? "text-lg text-sky-500 font-semibold border-b-2 border-sky-500 ml-3"
                  : "text-lg ml-3"
              }
            >
              Bus
          ...
          {selectMenu === 0 ? (
            <div className="py-5">
              <div className="grid grid-cols-2 gap-x-8 mb-5">
                ...
                <div>
                  <span className="text-lg font-bold">Total Guest</span>
                  <input
                    type="text"
                    ref={total_guest}
                    className="mt-1 px-3 py-2 bg-white border border-slate-300 shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1"
              ...
              <div className="grid grid-cols-2 gap-x-8 mb-5">
                <div>
                  ...
                  <DatePicker
                    ...
                    className="border border-slate-300 rounded-md w-full px-2 py-1.5 text-slate-400 text-sm shadow-sm"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-x-8 flex items-center">
                ...
                <div className="flex justify-end pt-3">
                  <button
                    onClick={onSearhHotel}
                    className="bg-orange-500 text-slate-50 font-semibold rounded-md px-10 py-2"
                  >
                    Cari Hotel
                  </button>
                </div>
